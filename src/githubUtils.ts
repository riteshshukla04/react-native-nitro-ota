...
export  function githubOTA({githubUrl, otaVersionPath='ota.version', ref = 'main'}:{githubUrl: string, otaVersionPath?: string, ref?: string}): {
    downloadUrl: string;
    versionUrl: string;
} {
    const downloadUrl = createDownloadableGitHubUrl(githubUrl, ref, GitHubRefType.BRANCH);
