///
/// NitroOta-Swift-Cxx-Bridge.cpp
/// This file was generated by nitrogen. DO NOT MODIFY THIS FILE.
/// https://github.com/mrousavy/nitro
/// Copyright © 2025 Marc Rousavy @ Margelo
///

#include "NitroOta-Swift-Cxx-Bridge.hpp"
...
namespace margelo::nitro::nitroota::bridge::swift {
  ...
  Func_void_bool create_Func_void_bool(void* NON_NULL swiftClosureWrapper) noexcept {
    auto swiftClosure = NitroOta::Func_void_bool::fromUnsafe(swiftClosureWrapper);
  ...
  Func_void_std__exception_ptr create_Func_void_std__exception_ptr(void* NON_NULL swiftClosureWrapper) noexcept {
    auto swiftClosure = NitroOta::Func_void_std__exception_ptr::fromUnsafe(swiftClosureWrapper);
  ...
  Func_void_std__string create_Func_void_std__string(void* NON_NULL swiftClosureWrapper) noexcept {
    auto swiftClosure = NitroOta::Func_void_std__string::fromUnsafe(swiftClosureWrapper);
  ...
  void* NON_NULL get_std__shared_ptr_HybridNitroOtaSpec_(std__shared_ptr_HybridNitroOtaSpec_ cppType) {
    ...
    if (swiftWrapper == nullptr) [[unlikely]] {
      throw std::runtime_error("Class \"HybridNitroOtaSpec\" is not implemented in Swift!");
    }
    #endif
    NitroOta::HybridNitroOtaSpec_cxx& swiftPart = swiftWrapper->getSwiftPart();
